...
2. If you haven't upgraded your nopCommerce website to version 3.8 already, then follow the instructions in the "nopCommerce_readme.txt".
...
5. Start your site. If you have made any changes to this plugin in 3.7 then you need to merge them in the new version of the plugin.
